...
for i in range(10):
    ...
    image = pipe(prompt=prompt, negative_prompt=negative_prompt, width=512, height=512, num_inference_steps=50).images[0]
    image.save("output/weapon/t1_{}_{}.png".format(i, id))
